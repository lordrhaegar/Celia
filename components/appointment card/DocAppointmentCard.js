...
const DocAppointmentCard = (props) => {
    const {
        cardTitle,
        appointments,
        status,
                    ...
                    >
                        {
                            appointments.map((appointment, idx) => {
                                if (appointment.status === status) {
                                    const docInfo = appointment.patientId
                                    ...
                                    return (
                                        ...
                                        key={idx} style={[doctorsStyles.appointmentWorkersItemContainer, { borderColor: status === "rescheduled" ? "#EABF6E" : "", borderWidth: status === "rescheduled"? 1:0 }]}>
